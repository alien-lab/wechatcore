...
public class OnliveStart extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		try{
			...
			//启动加载白名单
			namelistItemService.findAllNamelistItem();
			//启动加载已有直播间
			onliveRoomService.findAllOnliveRoom();
	...
	public static boolean createMenu(){
		...
		String createurl = WeixinUtil.getAuthUrl("http://www.bigercat.com/wechatsolution/onlive/mobile/CreateRoom.jsp", null, "info");
		...
		String mineurl = WeixinUtil.getAuthUrl("http://www.bigercat.com/wechatsolution/onlive/mobile/myroom.jsp", null, "info");
